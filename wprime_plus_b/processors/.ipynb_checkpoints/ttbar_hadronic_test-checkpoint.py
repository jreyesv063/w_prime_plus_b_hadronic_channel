                    ...
                    if self.is_mc and syst_var == "nominal":
                        ...
                        for variation in event_weight_syst:
                            ...
                            for kin in hist_dict:
                                ...
                                # fill histograms
                                """
                                # lineas para generar el error de longituf
                                print(len(fill_args['top_mrec']))
                                print(len(syst_weight))
                                fill_args['top_mrec'] = ak.concatenate([fill_args['top_mrec'], ak.Array([20.5])])
                                syst_weight = ak.concatenate([syst_weight, ak.Array([20.5])])
                                print(len(syst_weight))
                                print("\n")
                                """
                                hist_dict[kin].fill(
